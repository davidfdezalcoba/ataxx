 ...
 * to play, the players list, etc.. More information is available at the <a
 * href="https://commons.apache.org/proper/commons-cli"/>commons-cli</a> page
 * 
 * <p>
 ...
 * información sobre esta libreria en la pagina de <a
 * href="https://commons.apache.org/proper/commons-cli"/>commons-cli</a>
 */
public class Main {
	 ...
	 */
	private static void parseDimensionOption(CommandLine line)
			throws ParseException {
